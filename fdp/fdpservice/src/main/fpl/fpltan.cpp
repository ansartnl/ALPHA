...
void FPLfromTAN::prepareInsert(db::CDBQuery& query)
{
...
void FPLfromTAN::prepareUpdate(db::CDBQuery& query)
{
...
void FPLfromTAN::prepareSelect(db::CDBQuery& query)
{
...
void FPLfromTAN::updateInfo(db::CDBQuery& query)
{
...
void FPLfromTAN::updateQuery(db::CDBQuery& query)
{
...
void FPLfromTAN::prepareSelectAll(db::CDBQuery& query, const QString& sTable, const QString& sWhere)
{
    query.Prepare("SELECT "
                  TBL_FPL_ID ", "
                  TBL_FPL_FIR_NAME ", "
...
/** Fill query for INSERT request */
void FPLfromFDP::prepareInsert(db::CDBQuery& query)
{
    query.Prepare("INSERT INTO " + table + "("
                  TBL_FPL_ID ", "
                  TBL_FPL_FIR_NAME ", "
...
/** Fill query for UPDATE request */
void FPLfromFDP::prepareUpdate(db::CDBQuery& query)
{
    query.Prepare("UPDATE " + table + " SET "
                  TBL_FPL_FIR_NAME " = :" TBL_FPL_FIR_NAME ", "
                  TBL_FPL_AIRCRAFT_ID " = :" TBL_FPL_AIRCRAFT_ID ", "
...
/** Fill query for SELECT request */
void FPLfromFDP::prepareSelect(db::CDBQuery& query)
{
    query.Prepare("SELECT "
                  TBL_FPL_ID ", "
                  TBL_FPL_FIR_NAME ", "
...
/** Update information after SELECT request */
void FPLfromFDP::updateInfo(db::CDBQuery& query)
{
    updateInfo(query.record());
}
...
/** Set parameters to DB request */
void FPLfromFDP::updateQuery(db::CDBQuery& query)
{
    FPL::updateQuery(query);
    query.BindValue(":" + TBL_FPL_CHANGES_OPER, mOper);
    query.BindValue(":" + TBL_FPL_CHANGES_OPER_TIME, mOperTime);
...
/** Fill query for SELECT ALL request */
void FPLfromFDP::prepareSelectAll(db::CDBQuery& query, const QString& sTable, const QString& sWhere)
{
    query.Prepare("SELECT "
                  TBL_FPL_ID ", "
                  TBL_FPL_FIR_NAME ", "
