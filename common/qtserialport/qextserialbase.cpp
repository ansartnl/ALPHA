...
Default constructor.
*/
QextSerialBase::QextSerialBase(QObject *parent) : QIODevice(parent)
{
#ifdef Q_OS_WIN32
    setPortName("COM1");
...
*/
QextSerialBase::QextSerialBase(const QString &name, QObject *parent) : QIODevice(parent)
{
    setPortName(name);
    construct();
}
...
*/
QextSerialBase::BaudRate QextSerialBase::baudRate(void) const
{
...
*/
QextSerialBase::DataBitsType QextSerialBase::dataBits() const
{
...
*/
QextSerialBase::ParityType QextSerialBase::parity() const
{
...
*/
QextSerialBase::StopBitsType QextSerialBase::stopBits() const
{
...
*/
QextSerialBase::FlowType QextSerialBase::flowControl() const
{
...
{
    int index = QextSerialBase::staticMetaObject.indexOfEnumerator("BaudRate");
    QMetaEnum metaEnum = QextSerialBase::staticMetaObject.enumerator(index);
    const char* name = metaEnum.valueToKey(value);
    if (name)
        debug << "BaudRate(" << name << ')';
    else
