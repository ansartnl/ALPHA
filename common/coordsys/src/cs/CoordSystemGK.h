#ifndef COORD_SYSTEM_GK_H
#define COORD_SYSTEM_GK_H
...
class COORDSYS_EXPORT CCoordSystemGK : public CCoordSystem
{
public:
    CCoordSystemGK();

    //! Retrieve this class projection name.
