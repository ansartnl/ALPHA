...
/*!
    ...
    aircraftNumber is stored as part of the data.
    ...
    the version aircraftNumber to the restoreState() function to restore the
    saved state.
...
/*!
    ...
    \a version aircraftNumber is compared with the version aircraftNumber of the
    stored \a state.
...
//    ui.currentToolBarList->setAcceptDrops(true);
    ...
    d_ptr->ui.upButton->setIcon(QIcon(":/images/up.png"));
    d_ptr->ui.downButton->setIcon(QIcon(":/images/down.png"));
    d_ptr->ui.leftButton->setIcon(QIcon(":/images/back.png"));
    d_ptr->ui.rightButton->setIcon(QIcon(":/images/forward.png"));
    d_ptr->ui.newButton->setIcon(QIcon(":/images/plus.png"));
    d_ptr->ui.removeButton->setIcon(QIcon(":/images/minus.png"));
...
void QtToolBarDialog::changeEvent(QEvent *event)
{
  QDialog::changeEvent(event);

  switch (event->type()) {
    case QEvent::LanguageChange:
      d_ptr->ui.retranslateUi(this);
      break;
    default:
      break;
  }
