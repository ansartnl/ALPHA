...
{
  setObjectName("textEditDelegate");
}

// http://www.forum.crossplatform.ru/lofiversion/index.php? t2565.html
void TextEditDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option,
                                        ...
                                        const QModelIndex &/*index*/) const
{
  ...
  textEdit->installEventFilter(const_cast<TextEditDelegate *>(this));
...
void TextEditDelegate::updateEditorGeometry(QWidget *editor, const QStyleOptionViewItem &option
                                            , const QModelIndex &/*index*/) const
{
  QTextEdit *textEdit = qobject_cast<QTextEdit*>(editor);
...
QString TextEditDelegate::displayText(const QVariant &/*value*/, const QLocale &/*locale*/) const
{
  return QString::null;
}
...
// prog.org.ru
bool TextEditDelegate::eventFilter(QObject *object, QEvent *event)
{
...
QRectF TextEditDelegate::layoutRect(const QTextDocument & td, QRect rect, Qt::Alignment align) const
{
  //QRectF rectf;
  qreal xo = 0;
  qreal yo = 0;
