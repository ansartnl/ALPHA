...
void broadcast(const QByteArray &data, quint16 port, const QHostAddress &mask = QHostAddress());
void broadcast(const PulsData &data, quint16 port, const QHostAddress &mask = QHostAddress());
void sendActivate(const QHostAddress &host, quint16 port, const QHostAddress &mask
                  , const QVariantHash &addInfo = QVariantHash());
