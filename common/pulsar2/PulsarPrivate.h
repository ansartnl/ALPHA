...
class PulsarPrivate : public QObject
{
    Q_OBJECT
public:
    explicit PulsarPrivate(bool passive, quint16 port
                           , const QVariantHash& additionalInfo = QVariantHash()
                           , QObject* parent = 0);
...
signals:
    ...
    void masterChanged(const QHostAddress &newpulsar, const QString &status
                       , const QHostAddress &oldpulsar, const QVariantHash &addInfo);
