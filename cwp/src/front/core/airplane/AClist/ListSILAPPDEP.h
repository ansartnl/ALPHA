#ifndef LIST_SIL_APP_DEP_H
#define LIST_SIL_APP_DEP_H
...
//! FPL's list SIL APP DEP
class CListSIL_APP_DEP : public CListAC,
	public AppSettings
{
Q_OBJECT
...
public:
	...
	*/
	explicit CListSIL_APP_DEP( CMaster* pMaster = 0, QWidget* pParent = 0);
	~CListSIL_APP_DEP();
