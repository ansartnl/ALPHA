#ifndef LIST_SIL_ACC_H
#define LIST_SIL_ACC_H

#include "front/common/XAppSettings.h"
#include "ListAC.h"

//! FPL's list SIL ACC
class CListSIL_ACC : public CListAC,
	public AppSettings
{
Q_OBJECT
...
public:
	...
	*/
	explicit CListSIL_ACC( CMaster* pMaster = 0, QWidget* pParent = 0);
	~CListSIL_ACC();
